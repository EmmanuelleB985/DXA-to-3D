...
class OptimizerConfig:
    ...
    kwargs: Dict[str, Any] = field(default_factory=lambda: {"betas": (0.9, 0.999), "eps": 1e-8})
...
class SchedulerConfig:
    ...
    enabled: bool = True
    name: str = "cosine"
    kwargs: Dict[str, Any] = field(default_factory=lambda: {"T_max": 100, "eta_min": 1e-6})
...
class DataConfig:
    ...
    dataset_params: Dict[str, Any] = field(
        default_factory=lambda: {"load_3d": False, "cache_data": False}
    )
...
def create_default_configs(output_dir: str = "configs") -> None:
    ...
    hydra_config = {
        ...
        "model": {
            "type": "transformer",
            "params": {"input_channels": 1, "hidden_dim": 512, "num_heads": 8, "num_layers": 6},
        },
    }
